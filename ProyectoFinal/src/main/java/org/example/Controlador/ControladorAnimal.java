    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getSource()==this.view.getBtnEliminar()) {
            ...
            if (e.getSource()==this.view.getBtnActualizar()){
                ...
                int rowIndex = this.view.getTblAnimal().getSelectedRow();
                Animal tmp = modelo.getAnimalIndex(rowIndex);
                Animal animal = new Animal();

                animal.setNombre(this.view.getTxtNombre2().getText());
                animal.setNombreCientifico(this.view.getTxtNombreCientifico2().getText());
                animal.setTipoDeDieta(this.view.getTxtTipoDeDieta2().getText());
                animal.setTamaDeEspecie(this.view.getTxtTamaDeEspecie2().getText());
                animal.setLinkImagen(this.view.getTxtLinkImagen2().getText());
                animal.setId(tmp.getId());
                if (modelo.ActualizarAnimal(animal)){
        ...
        if (e.getSource()==view.getTblAnimal()){
            ...
            this.view.getTxtNombreCientifico2().setText(temp.getNombreCientifico());
            this.view.getTxtTipoDeDieta2().setText(temp.getTipoDeDieta());
            this.view.getTxtTamaDeEspecie2().setText(temp.getTamaDeEspecie());
            this.view.getTxtLinkImagen2().setText(temp.getLinkImagen());
        }
        this.view.limpiar();
    }
