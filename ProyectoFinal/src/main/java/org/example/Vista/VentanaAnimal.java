...
public class VentanaAnimal extends JFrame {
    ...
    private JLabel lblNombreCientifico2;
    private JLabel lblTipoDeDieta2;
    private JLabel lblTamaDeEspecie2;
    private JLabel lblLinkImagen2;
    private JTextField txtId2;
    private JTextField txtNombre2;
    private JTextField txtNombreCientifico2;
    private JTextField txtTipoDeDieta2;
    private JTextField txtTamaDeEspecie2;
    private JTextField txtLinkImagen2;
    ...
    public VentanaAnimal(String title) throws HeadlessException {
        ...
        lblNombre2=new JLabel("Nuevo Nombre Casual:");
        lblNombreCientifico2=new JLabel("Nuevo Nombre Cientifico:");
        lblTipoDeDieta2=new JLabel("Nuevo Tipo de Dieta:");
        lblTamaDeEspecie2=new JLabel("Nueva Altura de la especie en metros:");
        lblLinkImagen2=new JLabel("Nuevo Link de Imagen:");
        txtId2=new JTextField(3);
        txtId2.setText("0");
        txtId2.setEnabled(false);//Para que no se pueda usar este control
        txtNombre2=new JTextField(15);
        txtNombreCientifico2=new JTextField(15);
        txtTipoDeDieta2=new JTextField(10);
        txtTamaDeEspecie2=new JTextField(10);
        txtLinkImagen2=new JTextField(45);
        panel4.add(lblId2);
        panel4.add(txtId2);
        panel4.add(lblNombre2);
        panel4.add(txtNombre2);
        panel4.add(lblNombreCientifico2);
        panel4.add(txtNombreCientifico2);
        panel4.add(lblTipoDeDieta2);
        panel4.add(txtTipoDeDieta2);
        panel4.add(lblTamaDeEspecie2);
        panel4.add(txtTamaDeEspecie2);
        panel4.add(lblLinkImagen2);
        panel4.add(txtLinkImagen2);
    ...
    public JLabel getLblNombreCientifico2() {
        return lblNombreCientifico2;
    }

    public void setLblNombreCientifico2(JLabel lblNombreCientifico2) {
        this.lblNombreCientifico2 = lblNombreCientifico2;
    }

    public JLabel getLblTipoDeDieta2() {
        return lblTipoDeDieta2;
    }

    public void setLblTipoDeDieta2(JLabel lblTipoDeDieta2) {
        this.lblTipoDeDieta2 = lblTipoDeDieta2;
    }

    public JLabel getLblTamaDeEspecie2() {
        return lblTamaDeEspecie2;
    }

    public void setLblTamaDeEspecie2(JLabel lblTamaDeEspecie2) {
        this.lblTamaDeEspecie2 = lblTamaDeEspecie2;
    }

    public JLabel getLblLinkImagen2() {
        return lblLinkImagen2;
    }

    public void setLblLinkImagen2(JLabel lblLinkImagen2) {
        this.lblLinkImagen2 = lblLinkImagen2;
    }
    ...
    public JTextField getTxtNombreCientifico2() {
        return txtNombreCientifico2;
    }

    public void setTxtNombreCientifico2(JTextField txtNombreCientifico2) {
        this.txtNombreCientifico2 = txtNombreCientifico2;
    }

    public JTextField getTxtTipoDeDieta2() {
        return txtTipoDeDieta2;
    }

    public void setTxtTipoDeDieta2(JTextField txtTipoDeDieta2) {
        this.txtTipoDeDieta2 = txtTipoDeDieta2;
    }

    public JTextField getTxtTamaDeEspecie2() {
        return txtTamaDeEspecie2;
    }

    public void setTxtTamaDeEspecie2(JTextField txtTamaDeEspecie2) {
        this.txtTamaDeEspecie2 = txtTamaDeEspecie2;
    }

    public JTextField getTxtLinkImagen2() {
        return txtLinkImagen2;
    }

    public void setTxtLinkImagen2(JTextField txtLinkImagen2) {
        this.txtLinkImagen2 = txtLinkImagen2;
    }
